...
use pcie_remote_userspace_sdk::PcieDevice;
...
mod tests {
    ...
    use pcie_remote_userspace_sdk::DeviceCtx;
    use pcie_remote_userspace_sdk::PcieDevice as Pde;
    use pcie_remote_userspace_sdk::pcie_remote_protocol::DeviceDescribe;
    use std::os::unix::net::UnixStream;
    use std::thread;
